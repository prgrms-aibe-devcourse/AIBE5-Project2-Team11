        ...
        <div className="relative z-10 px-10 py-24 text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            <button
              ...
              className="px-7 py-3 bg-[#2C160D] text-white font-bold rounded-full shadow-lg hover:bg-[#3A2317] transition inline-flex items-center justify-center gap-2 group cursor-pointer"
            >
